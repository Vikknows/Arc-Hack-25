...
export default function CrossPayDashboard() {
  ...
  return (
    ...
    <div className="dashboard-note">
      <p>
        This section is wired to the live FastAPI backend and Python routing_service.
        Only the controls inside this “CrossPay live engine” panel are interactive –
        the rest of the page is a static marketing shell.
      </p>
    </div>
